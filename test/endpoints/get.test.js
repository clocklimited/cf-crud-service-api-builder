...
describe('GET endpoint', () => {
  ...
  describe('GET /prefix/:id', () => {
    ...
    it('should respond with a 200 when service#read() returns an object', done => {
      const app = express()
    ...
    it('should respond with a 404 when service.read() doesn’t return anything', done => {
      const app = express()
      createGetEndpoint(service, '/things', app, logger, [], null, hooks)
      request(app)
        .get('/things/2')
    ...
    it('should respond with a 400 when service.read() errors', done => {
  ...
  describe('GET /prefix', () => {
    ...
    it('should respond with a 200 and list of items when service.find() returns some objects', done => {
      const app = express()
      createGetEndpoint(service, '/things', app, logger, [], null, hooks)
      request(app)
        .get('/things')
    ...
    it('should respond with a 400 and list of items when service.find() errors', done => {
    ...
    it.skip('should successfully paginate requests', done => {
      const app = express()
      createGetEndpoint(service, '/things', app, logger, [], null, hooks)
      request(app)
